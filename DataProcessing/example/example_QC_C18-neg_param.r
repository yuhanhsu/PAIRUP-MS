##########################################################################################
### Config file for running QC_submission_script.r (for C18-neg data)
##########################################################################################
...
file.raw <- "example_raw_data_C18-neg.txt" # raw metabolite data file
file.sampleRunWindow <- "example_sample_run_window.txt" # What file to read for defining windows

met.type <- "C18-neg" # profilng method name
met.column <- "Metabolite" # column containing metabolite names
IS.name <- "Known_C18-neg_IS" # internal standard name (used for IS normalization)
